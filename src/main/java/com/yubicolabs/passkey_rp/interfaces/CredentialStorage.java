...
/*
 * CRUD operations for the credential repository
 * Extended interface is used to allow for the dynamic use of different storage providers
 */
public interface CredentialStorage extends CredentialRepository {
   ...
   * 
   * @param username     denotes the user who is creating the new credential
   ...
   *         otherwise
   */
  public Boolean addRegistration(String username, CredentialRegistration registration);
