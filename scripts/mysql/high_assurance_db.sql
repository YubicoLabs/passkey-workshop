USE passkeyStorage;
DROP TABLE IF EXISTS hibernate_sequence, attestation_requests, assertion_requests, credential_registrations, account_transaction, account, user;
CREATE TABLE user (
...
CREATE TABLE account_transaction (
    ...
    amount DECIMAL(13,2),
    status BOOL,
    transaction_create_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    description TEXT,
    PRIMARY KEY (id),
