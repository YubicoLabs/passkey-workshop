...
while ! /opt/keycloak/bin/kcadm.sh config credentials --server http://localhost:8080 --realm master --user admin --password m7S6eZ5rTvgMBDv9qLMy --client admin-cli &> /dev/null ; do
